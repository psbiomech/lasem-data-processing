        ...
        if ~isfield(meta,subtri{f}{1})
            ...
            for g=1:length(subtri)
                if strcmpi(subtri{f}{1},subtri{g}{1})
                    [meta.(subtri{g}{1}).(subtri{g}{2}).vfrange,~,meta.(subtri{g}{1}).(subtri{g}{2}).afrange,~,meta.(subtri{g}{1}).(subtri{g}{2}).fpsequence,meta.(subtri{g}{1}).(subtri{g}{2}).triallimb] = getC3Dwindow(flist{g},task,tlmode,bbmeta,subtri{g}{1},subtri{g}{2});
