function datastruct = analysis_eventval_moment(datastruct,bbmeta,user,vfrange,ecodes,eframes)


%analysis_eventval_moment: Get moment values at events
