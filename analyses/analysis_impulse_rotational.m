function bbstruct = analysis_impulse_rotational(bbstruct,bbmeta,subj,trial)


%  analysis_impulse_rotational: Joint rotational impulse
%   Prasanna Sritharan, August 2017
%
%   Requires joint moment in BB structure
% 
% -------------------------------------------------------------------- 
