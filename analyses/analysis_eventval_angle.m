function datastruct = analysis_eventval_angle(datastruct,bbmeta,user,vfrange,ecodes,eframes)


%analysis_eventval_angle: Get angle values at events
...
% -------------------------------------------------------------------- 
    ...
    GRPOUT = upper(bbmeta.BBANALYSES{4});   

    % midstring
    INMIDSTR = GRPIN(1:end-1);
    OUTMIDSTR = bbmeta.BBANALYSES{4};     
