...
% folder paths
user.DATASRCPATH = 'C:\Users\psritharan\Documents\98 Data Repository\Matt King\All data excl less symp large stride\';  % root directory of source C3D files with Body Builder data
user.SUMMARYPATH = 'C:\Users\psritharan\Documents\98 Data Repository\Matt King\All data excl less symp large stride\SUMMARY\';   % location to which all output data summary files are written
user.XLSMETAPATH = 'C:\Users\psritharan\Documents\98 Data Repository\Matt King\All data excl less symp large stride\XLSMETA\';   % if used, read.write location of XLS file with subject/trial metadata
...
user.UPDATEMETA = 'noupdate';  % update subject cohort and affected limb via XLS (update/noupdate)
